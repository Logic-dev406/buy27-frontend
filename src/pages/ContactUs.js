  ...
  return (
    <div className=" w-full flex flex-col items-center justify-center px-2 md:px-10 lg:px-52 py-8 md:py-28 bg-gray-100">
      ...
      <div className="flex flex-col md:flex-col lg:flex-row w-full items-center justify-center mb-5">
        ...
        <div className="flex flex-col items-center w-full mx-0 lg:mx-5 my-2">
      ...
      <button className="h-10 w-28 focus:outline-none rounded bg-primary-light hover:bg-primary-dark font-normal text-sm text-white mt-10">
        SEND
      </button>
    </div>
  );
